...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ name: string; photoUrls: string[]; id?: number; category?: { id?: number; name?: string; }; status?: 'available' | 'pending' | 'sold'; tags?: { id?: number; name?: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/pet \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"api_key: $PETSTORE_API_KEY\" \\\n    -d '{\n          \"name\": \"doggie\",\n          \"photoUrls\": [\n            \"string\"\n          ],\n          \"id\": 10\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/pet/findByStatus \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/pet/findByTags \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/pet/$PET_ID \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/pet/$PET_ID/uploadImage \\\n    -H 'Content-Type: application/octet-stream' \\\n    -H \"api_key: $PETSTORE_API_KEY\" \\\n    -F 'image=@/path/to/image'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/store/inventory \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id?: number; complete?: boolean; petId?: number; quantity?: number; shipDate?: string; status?: 'placed' | 'approved' | 'delivered'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/store/order \\\n    -X POST \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/store/order/$ORDER_ID \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id?: number; email?: string; firstName?: string; lastName?: string; password?: string; phone?: string; username?: string; userStatus?: number; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/user \\\n    -X POST \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/user/createWithList \\\n    -X POST \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/user/login \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/user/logout \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/user/$USERNAME \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://petstore3.swagger.io/api/v3/user/$EXISTING_USERNAME \\\n    -X PUT \\\n    -H \"api_key: $PETSTORE_API_KEY\""
      }
    }
  },
  {
